...
public class TestPublication {
    public static void main(String[] args) {
        ...
        Publication[1] = new Magazine("null",0,0.0 ,"null" ,"null" );
        Publication[2] = new Magazine("DC",30,3.0 ,"Aquaman" ,"weekly" );
        Publication[3] = new Book("null",0,0.0 ,"null" ,"null" );
        Publication[4] = new Book("null",0,0.0 ,"null" ,"J.R.R Tolkein" );
        Publication[5] = new Book("Future of AI",200,40.4 ,"ROV" ,"Monthly" );
        Publication[6] = new Book("Future of AI",200,40.4 ,"Batman" ,"Monthly" );
        Publication[7] = new KidsMagazine("null",0,0.0 ,"null" ,0 );
